      ...
      <div className={styles.container}>
        <div className={styles.realizacao}>
          ...
          <div className={styles.images}>
            <Image src="/recepcaocalouros/images/logo_pet.svg" alt="Logo PET" />
            <Image src="/recepcaocalouros/images/cainfo.png" alt="Logo cainfo" />
            <Image src="/recepcaocalouros/images/caccom.png" alt="Logo caccom" />
            <Image src="/recepcaocalouros/images/conectadas.png" alt="Logo PET" />
            <Image className={styles.logoDin} src="/recepcaocalouros/images/din.png" alt="Logo DIN" />
            <Image src="/recepcaocalouros/images/UEM.png" alt="Logo UEM" />
          </div>
        </div>
            ...
            <div className={styles.pet}>
              <a href="http://www.instagram.com/petinfouem" rel="noreferrer" target="_blank" className={styles.insta}>
                <div className={styles.icon}>
                  <Image src="/recepcaocalouros/images/instagram.svg" alt="Icone instagram" />
                </div>
              ...
              >
                <div className={styles.icon}>
                  <Image className={styles.iconFace} src="/recepcaocalouros/images/facebook.png" alt="Icone facebook" />
                </div>
